      ...
      <div className="container mx-auto flex flex-col items-center py-12 sm:py-24 md:py-5">
        <div className="flex flex-wrap md:flex-nowrap items-center justify-center">
          <div className="md:w-1/2  sm:w-2/3 lg:flex justify-center items-center flex-col  mb-5 sm:mb-10">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl  text-gray-800 font-black leading-7 md:leading-10 bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 text-transparent bg-clip-text">
          ...
          <div className="md:w-1/2 md:basis-1/2  relative before:-z-5 before:w-full before:h-full before:absolute before:-right-10 before:rounded-tl-[60px]  before:-top-5 ">
            <div className="">
              <img
