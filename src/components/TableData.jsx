        ...
        <div className="table flex justify-between w-full">
          ...
          <span className="inline-block w-full">
            ...
            <div className="lg:flex text-gray-400 justify-between w-full object-contain">
              ...
              <div className="w-4/12 hidden lg:block pr-4">Fall In Love</div>
                ...
                <a href="/track/5uCiNprPNbFsE3OLCWLz3M">
                  <div className="w-full flex items-start mb-7 w-full pr-8 truncate overflow-hidden">
                    ...
                    <div className="ml-4 truncate">
                      ...
                      <h3 className="text-sm text-gray-700 truncate">T.I.</h3>
                    </div>
                  </div>
                </a>
              </div>
              <div className="w-4/12 hidden lg:block pr-4">Paper Trail</div>
            ...
            <div className="lg:flex text-gray-400 justify-between w-full object-contain">
              ...
              <div className="w-4/12 hidden lg:block pr-4">The Eminem Show</div>
