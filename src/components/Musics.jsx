        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          ...
          <div className="rounded-2xl p-3">
            <div className="group relative">
              <img
                ...
                alt=""
              />
              <div className="absolute bg-black rounded-2xl bg-opacity-0 group-hover:bg-opacity-60 w-full h-full top-0 flex items-center group-hover:opacity-100 transition justify-evenly">
            ...
            <div className="p-1">
              <h3 className="text-gray-600 text-lg">Epoch</h3>
          ...
          <div className="rounded-2xl p-3">
            ...
            <div className="p-1 rounded">
              <h3 className="text-gray-600 text-lg">Awake</h3>
              <p className="text-gray-400">Tycho</p>
            </div>
          </div>
          {/* END OF CARD 2 */}
          ...
          <div className="rounded-2xl p-3">
            ...
            <div className="p-1">
              <h3 className="text-gray-600 text-lg">Dive</h3>
              <p className="text-gray-400">Tycho</p>
            </div>
          </div>
          {/* END OF CARD 3 */}
