...
function App() {
  ...
  const CLIENT_SECRET =  "16964a0230c14b21afff52cf4c483f67"; 
  ...
  useEffect(()=>{
    ...
    setState((state)=>({...state,token:access_token,authorize_token:(`${token_type} ${access_token}`)}));
    const responseSearch = await fetch('https://api.spotify.com/v1/search?q=Fally&type=album,track,artist,playlist,show,episode&include_external=audio',{
      method:"GET",
      headers:{
